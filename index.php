                                ...
                                <div class="header_account_area">
                                    <div class="header_account-list top_links">
                                        ...
                                        <ul class="dropdown_links">
                                            ...
                                            <li><a href="wishlist.html"><i class="fa fa-sign-in" aria-hidden="true"></i> Login</a></li>
                                            <li><a href="wishlist.html"><i class="fa fa-sign-out" aria-hidden="true"></i> Logout</a></li>
                                        </ul>
                                    </div>
